    ...
    <div class="table-wrapper" v-if="initialised">
        ...
        <div class="card">
            ...
            <div class="card-body m-0 p-0">
                <div class="alert alert-warning m-0 p-6 text-center" v-if="body && body.data.length === 0">
                    <p class="lead m-0 p-0">
                        <fa icon="exclamation-circle" class="mr-1"/> {{ $t('no_records_found') }}
                    </p>
                </div>
                <div class="table-responsive" v-else v-responsive>
            ...
            <div class="card-footer">
                <bottom-controls class="bottom-controls"
                                 ...
                                 v-if="hasContent"
                />
                <div class="text-center alert alert-warning no-records-found"
                     v-if="isEmpty">
                    {{ $t('no_records_found') }}
                </div>
            </div>
